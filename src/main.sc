...
theme: /
    ...
    state: Start
        ...
        script: 
            $session = {}
        a: Привет! Предлагаю сыграть в игру "Виселица". Я загадаю слово, а ты будешь отгадывать. Ты можешь угадывать по буквам или попробовать назвать слово целиком. Ты можешь ошибиться 6 раз. Начнем?
        go!: /Start/Ready
